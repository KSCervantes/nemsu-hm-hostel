  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <header className="fixed top-0 left-0 right-0 z-30 flex items-center justify-between px-6 py-4 transition-all duration-300 pointer-events-none">
        ...
        <div className="animate-fade-in pointer-events-auto flex items-center gap-3">
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-orange-500/30 blur-2xl rounded-full scale-150 group-hover:bg-orange-500/40 transition-all duration-300"></div>
            <img
              src="/img/NEMSU.png"
              alt="NEMSU Logo"
              className="relative h-16 w-16 object-contain drop-shadow-[0_0_20px_rgba(249,115,22,0.5)] hover:scale-110 hover:rotate-3 transition-all duration-300"
            />
          </div>
          {/* BSHM Logo */}
          <div className="relative group">
            <div className="absolute inset-0 bg-amber-500/30 blur-2xl rounded-full scale-150 group-hover:bg-amber-500/40 transition-all duration-300"></div>
            <img
              src="/img/BSHM LOGO.jpg"
              alt="BSHM Logo"
              className="relative h-16 w-16 object-contain rounded-full drop-shadow-[0_0_20px_rgba(245,158,11,0.5)] hover:scale-110 hover:-rotate-3 transition-all duration-300"
            />
          </div>
        </div>
        ...
        <div className="flex gap-3 animate-fade-in pointer-events-auto">
          <a
            href="https://hospitality-management-operation.vercel.app/"
              className="px-6 py-3 bg-orange-600 rounded-full text-white font-bold text-sm shadow-button transition-all duration-300 hover:scale-105 btn-hero-primary relative overflow-hidden group hover:bg-orange-700"
          >
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        {/* Solid Background */}
        <div className="absolute inset-0 w-full h-full bg-[#0b1834]" />
        ...
        <div className="relative z-20 text-center px-6 max-w-6xl">
          ...
          <h1 className="mb-8 leading-tight animate-slide-up">
            <span className="block text-2xl sm:text-3xl md:text-4xl font-light tracking-[0.15em] text-orange-200/90 mb-4">
              Welcome to
            </span>
            <span className="block text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-serif font-bold tracking-wide">
              <span className="hero-text-gradient bg-clip-text text-transparent">HOSTEL</span>
            </span>
          </h1>

          {/* Subtitle with Refined Styling */}
          <p className="text-xl sm:text-2xl md:text-3xl text-white/95 mb-6 max-w-4xl mx-auto leading-relaxed font-light tracking-wide animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Your home away from home at <span className="text-amber-300 font-medium">NEMSU - Lianga Campus</span>
          </p>

          {/* Feature Tags */}
          <div className="flex flex-wrap justify-center gap-3 md:gap-6 mb-12 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <span className="flex items-center gap-2 text-orange-100/90 text-sm md:text-base">
              <span className="w-2 h-2 rounded-full bg-orange-400 animate-pulse"></span>
              Comfortable accommodations
            </span>
            <span className="flex items-center gap-2 text-orange-100/90 text-sm md:text-base">
              <span className="w-2 h-2 rounded-full bg-amber-400 animate-pulse" style={{ animationDelay: '0.3s' }}></span>
              Delicious meals
            </span>
            <span className="flex items-center gap-2 text-orange-100/90 text-sm md:text-base">
              <span className="w-2 h-2 rounded-full bg-red-400 animate-pulse" style={{ animationDelay: '0.6s' }}></span>
              Student-friendly
            </span>
          </div>
          ...
          <div className="flex gap-5 sm:gap-8 justify-center flex-wrap items-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <button
              onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
                className="group inline-flex items-center gap-3 text-white font-bold py-4 px-10 sm:px-14 rounded-full shadow-button transition-all duration-300 text-base sm:text-lg bg-orange-600 hover:scale-105 hover:bg-orange-700 btn-hero-primary"
            >
            ...
            <button
              onClick={() => document.getElementById('menu')?.scrollIntoView({ behavior: 'smooth' })}
                className="group inline-flex items-center gap-3 text-white font-bold py-4 px-10 sm:px-14 rounded-full shadow-button transition-all duration-300 text-base sm:text-lg bg-orange-600 hover:scale-105 hover:bg-orange-700 btn-hero-secondary"
            >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-5 text-black dark:text-white">
              Ready to Start Your <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Journey?</span>
            </h2>
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-3 text-white font-bold py-4 px-10 sm:px-12 rounded-full shadow-button transition-all duration-300 text-base sm:text-lg bg-orange-600 hover:scale-105 active:scale-95 hover:bg-orange-700"
                    >
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <h3 className="text-3xl font-bold bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent mb-4">NEMSU-Hostel</h3>
