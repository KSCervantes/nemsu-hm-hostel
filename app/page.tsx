          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-12">
            ...
            <div className="sm:col-span-2 lg:col-span-2">
              ...
              <div className="flex gap-3 sm:gap-4">
                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-zinc-800 hover:bg-orange-500 flex items-center justify-center text-white transition-all duration-300 hover:scale-110 active:scale-95">
